...
// -----------------------------------------------------------------------------
// 1. MASTER STANDALONE VECTOR LOGO SVG (512x512) - Pure vidIQ-Style Freestanding Glyph
// No outer bounding box, no white border, no phone brackets, pure transparent background.
// -----------------------------------------------------------------------------
const masterLogoSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  <defs>
    <!-- vidIQ Electric Cyan to Cobalt Blue Gradient -->
    <linearGradient id="vidiqGradTop" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    <!-- vidIQ Neon Violet to Laser Magenta Gradient -->
    <linearGradient id="vidiqGradBottom" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    <!-- Center Play/Iris Core Accent (Laser Emerald to Cyan) -->
    <linearGradient id="vidiqPlayGrad" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- High-Energy Freestanding vidIQ-Style Monogram "S" & Play Velocity Blades -->
  <g filter="url(#subtleDropShadow)" transform="translate(0, 0)">
    
    <!-- Outer Neon Ambient Aura -->
    <g opacity="0.4" filter="url(#neonBloom)">
      <!-- Top Wing Outline -->
      <path d="M 120 180 C 120 110 175 60 256 60 L 360 60 C 395 60 415 90 405 125 C 395 155 365 175 330 175 L 235 175 C 190 175 170 200 160 230 L 320 230 C 385 230 425 275 405 340 L 260 340 Z" fill="url(#vidiqGradTop)"/>
      <!-- Bottom Wing Outline -->
      <path d="M 392 332 C 392 402 337 452 256 452 L 152 452 C 117 452 97 422 107 387 C 117 357 147 337 182 337 L 277 337 C 322 337 342 312 352 282 L 192 282 C 127 282 87 237 107 172 L 252 172 Z" fill="url(#vidiqGradBottom)"/>
    </g>
    ...
    <g transform="translate(216, 216)">
      ...
      <polygon points="24,12 66,40 24,68" fill="url(#vidiqPlayGrad)" filter="url(#subtleDropShadow)"/>
    </g>
...
// -----------------------------------------------------------------------------
// 2. HERO BANNER SVG (1280x640) - Clean vidIQ Creator Studio Hero
// -----------------------------------------------------------------------------
const masterBannerSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 640" width="1280" height="640">
  ...
  <!-- Left Side: vidIQ Freestanding Logo Mark -->
  ...
  <g transform="translate(490, 165)">
    ...
    <!-- Feature Grid (4 vidIQ-Style Cards) -->
...
console.log(' Master borderless vidIQ-style SVG icons written.');
...
console.log('\n All borderless vidIQ-style brand assets generated successfully!');
